...
E.publishBtn.style.display=mode==='fleet'?'flex':'none';E.favBtn.style.display=mode==='driver'?'flex':'none';E.fType.onchange=dynamicForm;E.publishBtn.onclick=openPublish;E.favBtn.onclick=openFavorites;
// Cerut direct ("nu cred ca trebuie sa apara la soferi Metti il tuo
// annuncio in evidenza"): are sens doar pentru cineva care POATE
// publica un anunt (fleet, singurul cu buton de publicare) - soferul
// nu are niciun anunt propriu de promovat, deci bannerul nu inseamna
// nimic pentru el.
if(mode!=='fleet'){var promoStrip=document.getElementById('promoStrip');if(promoStrip)promoStrip.style.display='none'}
